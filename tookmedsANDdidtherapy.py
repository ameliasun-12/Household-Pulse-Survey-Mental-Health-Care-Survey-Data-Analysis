...
# %%
indicator_filter = "Took Prescription Medication for Mental Health And/Or Received Counseling or Therapy, Last 4 Weeks"
...
plt.title(f'Comparison of Differing Age Groups by Amount Who Took Prescription Medication for Mental Health And/Or Received Counseling or Therapy Over the Last 4 Weeks Over Time')
...
plt.figure(figsize=(14, 8))
sns.scatterplot(data=filtered_data, x='Time Period', y='Value', hue='Subgroup', palette='viridis')
plt.title(f'Comparison of Sexes by Amount Who Took Prescription Medication for Mental Health And/Or Received Counseling or Therapy Over the Last 4 Weeks Over Time')
plt.xlabel('Time Period')
plt.ylabel('Value')
plt.xticks(rotation=90)
plt.legend(title='Subgroup')
...
plt.figure(figsize=(14, 8))
sns.scatterplot(data=filtered_data, x='Time Period', y='Value', hue='Subgroup', palette='viridis')
plt.title(f'Comparison of Gender Identity by Amount Who Took Prescription Medication for Mental Health And/Or Received Counseling or Therapy Over the Last 4 Weeks Over Time')
plt.xlabel('Time Period')
plt.ylabel('Value')
plt.xticks(rotation=90)
plt.legend(title='Subgroup')
...
plt.figure(figsize=(14, 8))
sns.scatterplot(data=filtered_data, x='Time Period', y='Value', hue='Subgroup', palette='viridis')
plt.title(f'Comparison of Sexual Orientations by Amount Who Took Prescription Medication for Mental Health And/Or Received Counseling or Therapy Over the Last 4 Weeks Over Time')
plt.xlabel('Time Period')
plt.ylabel('Value')
plt.xticks(rotation=90)
plt.legend(title='Subgroup')
...
plt.figure(figsize=(14, 8))
sns.scatterplot(data=filtered_data, x='Time Period', y='Value', hue='Subgroup', palette='viridis')
plt.title(f'Comparison of Presence of Anxiety/Depression Symptoms by Amount Who Took Prescription Medication for Mental Health And/Or Received Counseling or Therapy Over the Last 4 Weeks Over Time')
plt.xlabel('Time Period')
plt.ylabel('Value')
plt.xticks(rotation=90)
plt.legend(title='Subgroup')
...
plt.figure(figsize=(14, 8))
sns.scatterplot(data=filtered_data, x='Time Period', y='Value', hue='Subgroup', palette='viridis')
plt.title(f'Comparison of Races by Amount Who Took Prescription Medication for Mental Health And/Or Received Counseling or Therapy Over the Last 4 Weeks Over Time')
plt.xlabel('Time Period')
plt.ylabel('Value')
plt.xticks(rotation=90)
plt.legend(title='Subgroup')
...
plt.figure(figsize=(14, 8))
sns.scatterplot(data=filtered_data, x='Time Period', y='Value', hue='Subgroup', palette='viridis')
plt.title(f'Comparison of Education Level by Amount Took Prescription Medication for Mental Health And/Or Received Counseling or Therapy Over the Last 4 Weeks Over Time')
plt.xlabel('Time Period')
plt.ylabel('Value')
plt.xticks(rotation=90)
plt.legend(title='Subgroup')
...
plt.figure(figsize=(14, 8))
sns.scatterplot(data=filtered_data, x='Time Period', y='Value', hue='Subgroup', palette='viridis')
plt.title(f'Comparison Between Abled and Disabled by Amount Who Took Prescription Medication for Mental Health And/Or Received Counseling or Therapy Over the Last 4 Weeks Over Time')
plt.xlabel('Time Period')
plt.ylabel('Value')
plt.xticks(rotation=90)
plt.legend(title='Subgroup')
...
plt.figure(figsize=(14, 8))
sns.scatterplot(data=filtered_data, x='Time Period', y='Value', hue='Subgroup', palette='viridis')
plt.title(f'Comparison of States by Amount Who Took Prescription Medication for Mental Health And/Or Received Counseling or Therapy Over the Last 4 Weeks Over Time')
plt.xlabel('Time Period')
plt.ylabel('Value')
plt.xticks(rotation=90)
plt.legend(title='Subgroup')
